...
Drive a locally installed Codex CLI through `codex app-server` and normalize its stable notifications into the typed `AgentEvent` stream consumed by the orchestrator.
