...
Persist workflow runs in SQLite, enforce the PRD §10 run/node/task state machines, append an immutable per-run event log, and turn successful agent final text into traceable report artifacts.
